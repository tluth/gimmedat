...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-main-800/10  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
  ...
  <SheetPortal>
    ...
    >
      ...
      <SheetPrimitive.Close
        className="absolute right-4 top-4 rounded-md opacity-80 transition-opacity hover:opacity-100 
