    ...
    <div>
      ...
      >
        {({ getRootProps, getInputProps, isDragActive }) => (
          <div
            {...getRootProps()}
            className={`flex flex-col items-center justify-center p-7 bg-white h-48 text-black cursor-pointer transition-border ease-in-out border-4 rounded-sm border-dashed ${
