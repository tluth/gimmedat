...
class AuthConfig:
    ...
    file_size_limit = environ.var(default=4294967296, help="max file size limit for uploads in bytes")
    storage_bucket = environ.var(default="gimmedat-dev-file-storage")
    blaclist_table_name = environ.var(default="gimmedat-dev-blacklist")
